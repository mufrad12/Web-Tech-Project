    ...
    <div class="bg">
      ...
      echo $_SESSION['userNameV'];
        ...
        $searchKey = $_SESSION['userNameV'];
			...
			$f1 = fopen("../database/admin.txt", "r");
			$data = fread($f1, filesize("../database/admin.txt"));
			fclose($f1);
      ...
      <input type="submit" name="update" value="Update" class="updateadminBtn" style="margin-left: 40%;">
      <input type="submit" name="delete" value="Delete" class="deleteadminBtn">
